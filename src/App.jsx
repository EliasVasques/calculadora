...
const App = () => {
  ...
  const inputNumbersRemovedPreviousZero = () => {
    // 09 -> 9 (0 antes da erro com eval)
  ...
  return (
    <div className="container">
      <div className="container-calculadora">
        ...
        <Button onClick={handleClickCe} cssId={'ce'}>
          CE
        </Button>
        <Button onClick={handleClickDel}>DEL</Button>
        <Button onClick={handleClickOperator} className={"operator"}>
          +
        </Button>
